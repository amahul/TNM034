...
eye_diff(round(2/3*nrows):nrows,:) = 0; 
...
% rectangle('Position', [eye_centers(1,1)-8, eye_centers(1,2)-8, 16, 16], 'EdgeColor', 'r', 'LineWidth', 4);
% rectangle('Position', [eye_centers(2,1)-8, eye_centers(2,2)-8, 16, 16], 'EdgeColor', 'r', 'LineWidth', 4);
end
